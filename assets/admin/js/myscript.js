          ...
          for (var j = 0; j < data[i].options.length; j++) {
            ...
            attrHtml += `
              <div class="row mb-0 option-row">
                ...
                <div class="col-lg-10 ${priceClass}">
                  <div class="row">
                    <div class="col-1">
                      +
                    </div>
                    ...
                    <div class="col-3">
                      ...
                      <div class="price-container">
                        ...
                        <input type="text" class="input-field price-input" id="${data[i].attribute.input_name}${data[i].options[j].id}_price" data-name="${data[i].attribute.input_name}_price[]" placeholder="Price" value="">
                      </div>
                    </div>
                    ...
                    <div class="col-3">
                      ...
                      <div class="price-container">
                        <span class="price-curr">${curr.sign}</span>
                        <input type="text" class="input-field price-input" id="${data[i].attribute.input_name}${data[i].options[j].id}_previous_price" data-name="${data[i].attribute.input_name}_previous_price[]" placeholder="Previous Price" value="">
                      </div>
                    </div>
                    ...
                    <div class="col-3">
                      ...
                      <div class="price-container">
                        ...
                        <input type="text" class="input-field price-input" id="${data[i].attribute.input_name}${data[i].options[j].id}_discount" data-name="${data[i].attribute.input_name}_discount[]" placeholder="Discount" value="">
                      </div>
                    </div>
...
if ($('.attr-checkbox').length > 0) {
  $('.attr-checkbox').each(function() {
    ...
    if($(this).prop('checked') == true) {
      ...
      if ($("#"+$(this).attr('id')+'_previous_price').val().length > 0) {
        // if previous price value is given
        fd.append($("#"+$(this).attr('id')+'_previous_price').data('name'), $("#"+$(this).attr('id')+'_previous_price').val());
      } else {
        // if previous price value is not given then take 0
        fd.append($("#"+$(this).attr('id')+'_previous_price').data('name'), 0.00);
      }
      
      if ($("#"+$(this).attr('id')+'_discount').val().length > 0) {
        // if discount value is given
        fd.append($("#"+$(this).attr('id')+'_discount').data('name'), $("#"+$(this).attr('id')+'_discount').val());
      } else {
        // if discount value is not given then take 0
        fd.append($("#"+$(this).attr('id')+'_discount').data('name'), 0);
      }
