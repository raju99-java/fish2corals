                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-6">
                                          <input class="form-control ship_input" type="text" name="shipping_country"
                                             id="shipping_country" placeholder="{{ __('Country') }}">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12  mt-3">
                                       <div class="bottom-area paystack-area-btn">
                                          <button type="submit" class="mybtn1 theme-bg-color text-white">{{ __('Continue') }}</button>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="col-lg-12 mt-3">
                                       <div class="bottom-area">
                                          <a href="javascript:;" id="step1-btn"
                                             class="mybtn1 mr-3 bg-dark text-white ">{{ __('Back') }}</a>
                                          <a href="javascript:;" id="step3-btn"
                                             class="mybtn1 theme-bg-color text-white ">{{ __('Continue') }}</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="col-lg-12 mt-3">
                                       <div class="bottom-area">
                                          ...
                                          <button type="submit" id="final-btn"
                                             class="mybtn1 mr-3 theme-bg-color text-white">{{ __('Continue') }}</button>
                                       </div>
