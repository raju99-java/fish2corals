...
<!-- <li>
    ...
    <!-- <li>
        <a href="{{ route('admin.menus.index') }}" class=" wave-effect"><i class="fa fa-bars"></i>{{ __('Menu Management') }}</a>
    </li> -->
    ...
    <li>
        <a href="{{ route('admin-enquiries-index') }}" class=" wave-effect"><i class="fas fa-users-cog mr-2"></i>{{ __('Enquiries') }}</a>
    </li> -->
