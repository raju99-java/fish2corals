...
/////////////////////////////// ////////////////////////////////////////////
  ...
  //------------ ADMIN PRODUCT BRAND SECTION ENDS ------------
...
// -------------------- Reward Section Route ---------------------//
  ...
  Route::post('/menus/create', 'Admin\MenuController@store')->name('admin.menus.store');
  //------------ADMIN MENU MANAGEMENT SECTION------------------
  ...
  Route::group(['middleware'=>'permissions:enquiries'],function(){
    ...
    Route::get('/enquiries/datatables', 'Admin\EnquiryController@datatables')->name('admin-enquiries-datatables'); //JSON REQUEST
    Route::get('/enquiries', 'Admin\EnquiryController@index')->name('admin-enquiries-index');
    Route::get('/enquiries/download', 'Admin\EnquiryController@download')->name('admin-enquiries-download');
  
    });
  
    //------------ ADMIN ENQUIRIES ENDS ------------
